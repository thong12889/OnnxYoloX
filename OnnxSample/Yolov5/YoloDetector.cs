...
namespace OnnxSample.Yolov5
{
    public class YoloDetector : IDisposable
    {
        ...
        public Size imgSize = new Size(640, 640);
        ...
        public YoloDetector(string model_path)
        {
            ...
            sess = new InferenceSession(model_path);
        ...
        public List<Prediction> objectDetection(Mat img, double confidence = 0.8  )
        {
            ...
            {
                //letterimg.ConvertTo(imageFloat, MatType.CV_32FC3, (float)(1.0 / 255.0));
                imageFloat = img.Resize(imgSize);
                            ...
                            if (indices != null)
                            {
                                for (int ids = 0; ids < indices.Length; ids++)
                                {
                                    ...
                                    predictions.Add(new Prediction
                                    {
                                        Box = new Box
                                        {
                                            Xmin = candidate[idx][0],
                                            Ymin = candidate[idx][1],
                                            Xmax = candidate[idx][2],
                                            Ymax = candidate[idx][3]
                                        },
            ...
            bool auto = true, bool scaleFill = false, bool scaleup = true)
        {
            ...
            /*var newUnpad = new OpenCvSharp.Size((int)640,
                (int)640);*/
            /*var newUnpad = new OpenCvSharp.Size((int)640,
                (int)384);*/
            ...
            if (newImage.Width != newUnpad.Width || newImage.Height != newUnpad.Height)
            {
                ...
                Cv2.Resize(newImage, newImage, new Size(640, 640));
            }
